         ...
         <tbody>
             ...
             <?php foreach ($model['data'] as $data) : ?>
                 <tr>
                     ...
                     <td><?php echo $data['hak_akses'] == "sekretaris" ? "Sekretaris" : "Ketua Divisi" ?></td>
 ...
 <div class="bm-modal h-auto" id="add_modal" role="dialog" aria-modal="true" aria-labelledby="modal-label" tabindex="-1">
     ...
     <form action="/AddPengguna" method="POST">
         ...
         <div class="bm-modal__body">
             ...
             <div class="bm-input">
                 <input name="nama_pengguna" type="text" id="nama" class="bm-input__field" placeholder="Contoh: John Doe" />
             </div>

             <br />
             <label class="bm-input-label" for="username">Username</label>
             <div class="bm-input">
                 <input name="username" type="text" id="username" class="bm-input__field" placeholder="Contoh: john_doe" />
             </div>
             ...
             <div class="bm-input">
                 <input name="password" type="password" id="password" class="bm-input__field" placeholder="Minimal 8 karakter" />
             </div>
             ...
             <div class="bm-input">
                 <input name="tahun_aktif" type="number" id="tahun-aktif" class="bm-input__field" placeholder="Contoh: 2021" />
             </div>
             ...
             <div class="row px-5">
                 ...
                 <label class="bm-radio col-6">
                     Sekretaris
                     <input type="radio" class="bm-radio__input" id="hak-akses-sekretaris" name="hak_akses" value="sekretaris" />
                     <span class="bm-radio__checkmark"></span>
                 </label>
             </div>
         </div>
 ...
 <div class="bm-modal h-auto" id="edit_modal" role="dialog" aria-modal="true" aria-labelledby="modal-label" tabindex="-1">
     ...
     <form action="/update-pengguna" method="POST">
         <div class="bm-modal__body">
             ...
             <input type="text" hidden name="id_pengguna" id="id_pengguna">
             <label class="bm-input-label" for="nama">Nama</label>
             <div class="bm-input">
                 <input name="nama_pengguna" type="text" id="update_nama" class="bm-input__field" placeholder="Contoh: John Doe" />
             </div>

             <br />
             <label class="bm-input-label" for="username">Username</label>
             <div class="bm-input">
                 <input name="username" type="text" id="update_username" class="bm-input__field" placeholder="Contoh: john_doe" />
             </div>
             ...
             <label class="bm-input-label" for="password">Password</label>
             <div class="bm-input">
                 <input name="password" type="password" id="update_password" class="bm-input__field" placeholder="Minimal 8 karakter" />
             </div>
             ...
             <label class="bm-input-label" for="tahun-aktif">Tahun aktif</label>
             <div class="bm-input">
                 <input name="tahun_aktif" type="number" id="update_tahun-aktif" class="bm-input__field" placeholder="Contoh: 2021" />
             </div>
             ...
             <div class="row px-5">
                 ...
                 <label class="bm-radio col-6">
                     Sekretaris
                     <input type="radio" class="bm-radio__input" id="update_hak-akses-sekretaris" name="hak_akses" value="sekretaris" />
                     <span class="bm-radio__checkmark"></span>
                 </label>
             </div>
         </div>
