...
<div class="bm-card mt-4 bg-white">
    <div class="bm-card__inner row">
        <div class="col">
            ...
            <div class="bm-input">
                <input type="text" id="nama-ketua" class="bm-input__field" placeholder="Masukkan nama lengkap ketua" />
            </div>

            <br />
            <label class="bm-input-label" for="nip-ketua">NIP ketua</label>
            <div class="bm-input">
                <input type="text" id="nip-ketua" class="bm-input__field" placeholder="Masukkan NIP ketua" />
            </div>
            ...
            <div class="bm-input">
                <textarea id="alamat" class="bm-input__field" placeholder="Contoh: Jl. Dipatiukur"></textarea>
            </div>
        ...
        <div class="col">
            ...
            <div class="bm-input">
                <input type="text" id="no-hp" class="bm-input__field" placeholder="Contoh: 081234567890" />
            </div>
            ...
            <div class="bm-input">
                <input type="text" id="no-wa" class="bm-input__field" placeholder="Contoh: 081234567890" />
            </div>
            ...
            <div class="bm-input">
                <input type="email" id="email" class="bm-input__field" placeholder="Contoh: contoh@mail.com" />
            </div>
            ...
            <div class="bm-input">
                <input type="text" id="username-ig" class="bm-input__field" placeholder="Contoh: pengguna_ig (tidak perlu menggunakan @)" />
            </div>
