      ...
      <div class="bm-modal__body">
        ...
        <div class="bm-input">
          <input
            ...
            id="nama-produk"
            class="bm-input__field"
            placeholder="Contoh: Seblak Mantap"
          />
        </div>
        ...
        <div class="bm-input">
          <textarea
            id="alamat"
            class="bm-input__field"
            placeholder="Contoh: Seblak dengan menggunakan kerupuk asli"
          ></textarea>
        </div>
        <br />
        ...
        <label
          for="logo"
          class="bm-input--file mt-4 mx-auto bm-cursor-pointer"
          id="label-logo"
        >
          <input
        ...
        <label for="logo" class="mx-auto mt-4 mb-2 text-center">
          <img
            class="w-50 bm-img-responsive bm-cursor-pointer"
            id="placeholder-logo"
            src="#"
            alt="Logo baru"
          />
